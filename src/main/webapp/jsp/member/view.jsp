        ...
        <div class="row">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>작성일자</td>
<%--                         <td colspan="2"><%= event.getEventDate().substring(0,11) + event.getEventDate().substring(11, 13) + "시" 
                                + event.getEventDate().substring(14,16) + "분"  %></td>
 --%>                    </tr>
                    <tr>
                        <td>내용</td>
            ...
            <%
                ...
                {
            %>
                <a href="update.jsp?eventID=<%=eventID %>" class="btn btn-primary">수정</a>
